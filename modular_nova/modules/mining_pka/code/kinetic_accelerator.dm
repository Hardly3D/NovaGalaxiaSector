...
/obj/item/gun/energy/recharge/kinetic_accelerator/variant/shockwave
	...
	desc = parent_type::desc + " Innovating on the mining blast mod, Mining Research and Development has managed to overclock the performance of the mod to the extreme. \
